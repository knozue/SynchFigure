...
=======
swimmer2005<-swimmer2017_11_12 %>% inner_join(swimmer2018_13_15) %>% unique()
>>>>>>> cdf10341f97c3570569f685d1a630f930e487a59
      Fig.data.s.summary[Fig.data.s.summary$name2 %in% swimmer2005$name2,"born"]<-"2005"
  
      ##### under construciton ########
    # Manual edition of born year of known swimmers
      Fig.data.s.summary[Fig.data.s.summary$name2=="YAMAMOTO, MARI","born"]<-"2002"
  ...
  pl <- reactive({
    ...
    # combine and calculate age
      Fig.data.ss<-Fig.data.s %>% left_join(Fig.data.s.summary[,c("name2","born")],by="name2") %>% mutate(age=interval(start=parse_date_time(born, orders = "Y"),end=DateTime2)/dyears(1)) %>% select(-name,-team.abb,-DateTime2,-year)  
