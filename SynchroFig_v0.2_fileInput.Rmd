...
server<-function(input, output) {
  ...
  pl <- reactive({
    ...
    ggplot(Fig.data.ss.selected,aes(x=age,y=score))  + geom_point() + geom_line(aes(group=name2,color=born,linetype=team),show.legend=c(group=FALSE,color=TRUE,linetype=TRUE))  + 
