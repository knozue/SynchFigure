...
## How to use this?
step1: Open this by RStudio
step2: Click "Run Document" and your browser will open a window for this app.
step3: Upload data csv file ("Synchro_Figure_score - record2.csv")
...
server<-function(input, output) {
  ...
  # To distinguish 2006 and 2007 based on age group 11-12 in 2017 and 2018
    ...
    # Manual edition of names
      Fig.data.s %>% mutate(name2=str_replace(name2,"MOORE, EMMA","MOORE, EMILEEN"))
    # save
