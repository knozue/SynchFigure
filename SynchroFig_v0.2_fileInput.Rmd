...
step3: Upload data csv file ("Synchro_Figure_score - record2.csv") and a table with swimmer's name list, team name, and average score, and year borned will be generated.
